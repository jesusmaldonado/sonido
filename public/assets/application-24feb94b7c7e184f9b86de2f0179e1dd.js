...
(function() { this.JST || (this.JST = {}); this.JST["home"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <ul class="popular-song-section">\n\n\n  </ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["likes/likesshow"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  likes.each(function(song){ ; __p.push('\n    <label>\n      <a href="#/songs/',  song.escape('id') ,'">\n        ',  song.escape('title') ,'\n      </a>\n      <ul class="song">\n        <li>\n          <a href="#/users/',  song.user().escape('id') ,'">\n            ',  song.user().escape('username') ,'\n          </a>\n        </li>\n        <li>\n          <a href="#/recordings/',  song.recording().escape('id') ,'">\n            ',  song.recording().escape('title') ,'\n          </a>\n        </li>\n        <li>\n          Lyrics: ',  song.escape('lyrics') ,'\n        </li>\n\n        ');  if (song.escape('liked') === "notliked") { ; __p.push('\n          <button class="likeSong button" data-song-id="',  song.id ,'">\n            &hearts;\n          </button>\n        ');  } else { ; __p.push('\n          <button class="unlikeSong button" data-song-id="',  song.id ,'">\n            &hearts;\n          </button>\n        ');  } ; __p.push('\n\n    </ul>\n    </label>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["playlists/button"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button class="addPlaylist">\n    Add a new playlist\n</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["playlists/playlistadd"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  playlists.each(function(playlist){ ; __p.push('\n\n  ');  if (playlist.songs().get(song.id)) { ; __p.push('\n    ');  var addOrDestroy = " -" ; __p.push('\n    ');  var hasSong = "inPlaylist" ; __p.push('\n  ');  } else { ; __p.push('\n    ');  var addOrDestroy = " +" ; __p.push('\n    ');  var hasSong = "notInPlaylist" ; __p.push('\n  ');  } ; __p.push('\n\n\n  <button class="selectedPlaylist" data-playlist-id=\'',  playlist.escape('id') ,'\' data-playlist-contains="',  hasSong ,'" >\n    ',  playlist.escape('title') + addOrDestroy ,'\n  </button>\n\n');   }) ; __p.push('\n<button class="makePlaylist">\n  Make Playlist\n</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["playlists/playlistform"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <button class="closeform">\n    X\n  </button>\n  <label for id="title"> Title: </label>\n  <p class="errors"></p>\n  <input type="text" id="title" name="playlist[title]" value="',  playlist.title ,'">\n  <br>\n  <select id="playliststaus" name="playlist[status]">\n      <option value="public">Public</option>\n      <option value="private">Private</option>\n  </select>\n  <br>\n\n  <input type="submit" class="playlistSubmit">\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["playlists/playlistshow"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="containerForAdd group">\n<button class="addPlaylist">\n    Add a new playlist\n</button>\n</div>\n\n');  playlists.each(function(playlist){ ; __p.push('\n    <a href="#/playlists/',  playlist.escape('id') ,'">\n      ',  playlist.escape('title') ,'\n      (',  playlist.escape('status') ,')\n\n    </a>\n      <button class="destroyPlaylist" data-playlist-id="',  playlist.id ,'">\n        X\n      </button>\n\n    <ul class="playlistsongs',  playlist.escape('id') ,'">\n    </ul>\n\n\n');   }) ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recordings/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n    <label> Title:\n      <input type="text" name="recording[title]">\n    </label>\n\n    <label> Description:\n      <textarea name="recording[description]">\n      </textarea>\n    </label>\n\n    <label>\n      Image:\n      <input type="file" name="recording[image]" id="input-post-image">\n    </label>\n\n    <img src="" id="preview-post-image">\n\n\n\n    <select name="recording[recording_type]">\n      <option value="album"> Album</option>\n      <option value="single"> Single </option>\n      <option value="ep"> EP </option>\n    </select>\n    <br>\n    <input type="submit" class="submit" value="Make new recording">\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recordings/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul>\n  <label>\n    <li>\n      ',  recording.escape('title') ,'\n    </li>\n    <div class="recordingImage">\n      <img src="',  recording.escape('image_url') ,'"></img>\n    </div>\n      <div class="containerForAdd">\n      </div>\n  </label>\n  <button class="addSong">\n    +\n  </button>\n  <br>\n  ');  count = 1 ; __p.push('\n  ');  recording.songs().each(function(song){ ; __p.push('\n    <label>   ',  count ,'\n        <li>\n          <a href="#songs/',  song.id ,'">\n            ',  song.escape('title') ,'\n          </a>\n        </li>\n    </label>\n    ');  count += 1 ; __p.push('\n  ');   }) ; __p.push('\n\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recordings/uploads"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <div class="navlinks">\n    <ul class="sidebarlinks">\n      <li class="sidebarlink">\n        <a href="#" > Home </a>\n      </li>\n      <li class="sidebarlink">\n        <a href="#myplaylists"> Playlists </a>\n      </li>\n      ');  if (currentUser.escape('account_type') === "artist") {; __p.push('\n      <li class="sidebarlink">\n        <a href="#myuploads"> Uploads </a>\n      </li>\n      ');  }  ; __p.push('\n      <li class="sidebarlink">\n        <a href="#mylikes"> Likes </a>\n      </li>\n      <li>\n        <a href="#mysettings"> Settings </a>\n      </li>\n    </ul>\n  </div>\n\n<nav class="navbar">\n    <ul class="userinfo">\n    ');  if (Sonido.currentUser.isSignedIn()) { ; __p.push('\n        <li>',  currentUser.escape('username') ,'</li>\n        <li>\n          <div class="profile-picture">\n            <img src="',  currentUser.escape('avatar_url') ,'">\n          </div>\n        <li>\n          <button class="logout">\n            Log Out\n          </button>\n        </li>\n\n        ');  if (currentUser.escape('account_type') === "artist") { ; __p.push('\n\n          <li>\n            <a href="#/newRecording">\n              <button>\n                Release a New Album, EP or Single\n              </button>\n            </a>\n          </li>\n          <li>\n            <a href="#/uploads">\n              <button href=>\n                View Your Uploads\n              </button>\n            </a>\n          </li>\n\n        ');  } ; __p.push('\n    ');   } else { ; __p.push('\n\n    <a href="#users/new">Sign Up</a> |\n    <a href="#session/new">Sign In</a>\n    ');  } ; __p.push('\n    </ul>\n\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["shared/sign_in"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="inputform">\n  <h1> Sign In </h1>\n  <label for="username">Username</label>\n  <input class="or" type="text" name="user[username]" id="username" value="',  user.username ,'">\n  <br>\n  <label for="email"> Email </label>\n  <input class="or" type="text" name="user[email]" value="',  user.email ,'">\n  <br>\n  <label for="password">Password</label>\n  <input type="password" name="user[password]" id="password">\n  <button class="demouser">Demo User</button>\n  <input class="submitinput" type="submit" value="Sign In">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["songs/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('    <button class="close">\n      X\n    </button>\n    <label> Title:\n      <input type="text" name="song[title]">\n    </label>\n\n    <label> Lyrics:\n      <textarea name="song[lyrics]">\n      </textarea>\n    </label>\n\n    <label>\n      Song\n      <input type="file" name="song[audio_song]" id="input-post-song">\n    </label>\n    \n    <input type="hidden" name="song[recording_id]" value="',  recording.id ,'">\n\n    <br>\n    <input type="submit" class="submit" value="Add new song">\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["songs/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="song">\n\n\n    <li class="songartist"> ',  song.user().escape("username") ,' </li>\n\n    <li class="songtitle">',  song.escape("title") ,' </li>\n\n    <li class="songuploaded">',  song.escape("upload_time") ,' </li>\n\n    <li class="songrecording">',  song.recording().escape("title") ,' </li>\n\n    <button class="playSong">\n      >\n    </button>\n\n    <audio src="',  song.escape('audio_url') ,'" id="Audio',  song.escape('id') ,'">\n    </audio>\n\n    ');  if (song.escape('liked') === "notliked") { ; __p.push('\n      <button class="likeSong button" data-song-id="',  song.id ,'">\n        &hearts;\n      </button>\n    ');  } else { ; __p.push('\n      <button class="unlikeSong button" data-song-id="',  song.id ,'">\n        &hearts;\n      </button>\n    ');  } ; __p.push('\n      <button class="addToPlaylist button" data-song-id="',  song.id ,'">\n        +\n      </button>\n    <div class="playlistformContainer addPlaylistForm',  song.id ,'">\n    </div>\n\n    <div class="containerAddPlaylist',  song.id ,'">\n    </div>\n\n    <div class="timeLeft',  song.id ,'">\n\n    </div>\n    <div class="renderer">\n      <div id="bars',  song.id ,'" class="area"></div>\n    </div>\n\n    ');  if (Sonido.currentUser.isSignedIn() && Sonido.currentUser.uploads().findWhere({id: song.id})){ ; __p.push('\n    <button class="destroySong button" data-id="',  song.escape('id') ,'">\n      Delete Song\n    </button>\n    ');  } ; __p.push('\n\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/userform"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<form class="inputform">\n  <h1> Sign Up </h1>\n  <label for="username">Username</label>\n  <input type="text" name="user[username]" id="username" value="">\n  <div class="errors inactive" id="usernameerrors"></div>\n  <br>\n  <label for="password">Password</label>\n  <input type="password" name="user[password]" id="password">\n  <div class="errors inactive" id="passworderrors"></div>\n  <br>\n  <label for="email"> Email </label>\n  <input type="text" name="user[email]" value="" id="email">\n  <div class="errors inactive" id="emailerrors"></div>\n  <br>\n  <label>\n    Image:\n    <input type="file" name="recording[image]" id="input-post-image">\n  </label>\n  <img src="" id="preview-post-avatar">\n  <div class="errors inactive" id="avatarerrors"></div>\n  <br>\n  <label for="accounttype">Account Type</label>\n  <select id="accounttype" class="accounttype" name="user[account_type]">\n    <option value="listener">Listener</option>\n    <option value="artist">Artist</option>\n  </select>\n  <div class="errors inactive" id="account_typeerrors"></div>\n  <br>\n  <button class="demouser">Demo User</button>\n\n  <input class="submitinput" type="submit" value="Sign Up!">\n</form>\n');}return __p.join('');};
}).call(this);
